...
latex_appendices = ['glosario','acerca','copyright','licencia','buildout/replicacion_proyectos_python','buildout/programar_tareas_crontab']
...
#http://sphinx.pocoo.org/ext/autodoc.html#confval-autodoc_default_flags
autodoc_default_flags = ['members', 'inherited-members', 'show-inheritance']

# http://sphinx.pocoo.org/latest/ext/autodoc.html#confval-autodoc_member_order
